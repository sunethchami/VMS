...
(3, 'Tom', 'Crouse', '920020031V', '0711041713', 'tom@gmail.com', '$2a$08$Ftye58Q9ZGnvqm1VaoXGLumCuEkVJQzy3OdgqmmtMqvOs0DCHU0.6'),
...
CREATE TABLE IF NOT EXISTS `vehicle_details_tb` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8226 DEFAULT CHARSET=latin1;
COMMIT;
