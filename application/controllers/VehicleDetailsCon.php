...
class VehicleDetailsCon extends MY_Controller {
    ...
    public function setNewRecord() {
        ...
        if ($access) {
            ...
            if ($owner != "" || $vehicle_number != "" || $model != "" ||
                ...
                $this->form_validation->set_rules('expense','Expense', 
                    'numeric',array('numeric' => 
                    'The %s field must contain only price.'));
                
                $this->form_validation->set_rules('monthly_fuel_intake',
                    'Monthly Fuel Intake', 'numeric',array('numeric' => 
                    'The %s field must contain only price.'));
    ...
    private function getVahicleDetailsWithFullValue($result) {
        ...
        foreach ($result as $key => $value) {
            ...
            $result[$key]['model'] == null || $result[$key]['model'] == '0' ? $result[$key]['model'] = "" : $result[$key]['model'] = $model->name;

            $usage = $this->UsageTypeModel
                    ->getRecordById($result[$key]['use_status']);

            $result[$key]['use_status'] == null || $result[$key]['use_status'] == '0' ? $result[$key]['use_status'] = "" : $result[$key]['use_status'] = $usage->name;
...
//                    = "Other" : "";
            ...
            $result[$key]['type'] == '1' ? $result[$key]['type'] = "6112101 - Passenger Vehicles" : "";
            $result[$key]['type'] == '2' ? $result[$key]['type'] = "6112102- Tractor Trailer" : "";
            $result[$key]['type'] == '3' ? $result[$key]['type'] = "6112102 - Cargo Vehicles" : "";
            $result[$key]['type'] == '4' ? $result[$key]['type'] = "6112103 - Tractors" : "";
            $result[$key]['type'] == '5' ? $result[$key]['type'] = "6112103 - Agriculture Vehicles" : "";
            $result[$key]['type'] == '6' ? $result[$key]['type'] = "6112104 - Industrial Vehicles" : "";
            $result[$key]['type'] == '7' ? $result[$key]['type'] = "6112109 - Motor Cycles" : "";
            $result[$key]['type'] == '8' ? $result[$key]['type'] = "6112109 - Bicycles" : "";
            $result[$key]['type'] == '9' ? $result[$key]['type'] = "6112110 - Trailers" : "";
            $result[$key]['type'] == '10' ? $result[$key]['type'] = "land vehicle" : "";
            $result[$key]['type'] == '11' ? $result[$key]['type'] = "6112111 - Other not specified above" : "";
            $result[$key]['running_status'] == '0' ? $result[$key]['running_status'] = "" : "";
            $result[$key]['running_status'] == '1' ? $result[$key]['running_status'] = "Running" : "";
            $result[$key]['running_status'] == '2' ? $result[$key]['running_status'] = "Not Running" : "";
            $result[$key]['running_status'] == '3' ? $result[$key]['running_status'] = "Under Repair" : "";
            $result[$key]['running_status'] == '4' ? $result[$key]['running_status'] = "Tender" : "";
            $result[$key]['grade'] == '0' ? $result[$key]['grade'] = "" : "";
            $result[$key]['grade'] == '1' ? $result[$key]['grade'] = "Special" : "";
            $result[$key]['grade'] == '2' ? $result[$key]['grade'] = "Grade 1" : "";
            $result[$key]['status_designation'] == '0' ? $result[$key]['status_designation'] = "" : "";
            $result[$key]['status_designation'] == '1' ? $result[$key]['status_designation'] = "Permanent" : "";
            $result[$key]['status_designation'] == '2' ? $result[$key]['status_designation'] = "Acting" : "";
            $result[$key]['status_designation'] == '3' ? $result[$key]['status_designation'] = "Performing Duties" : "";
            $result[$key]['status_designation'] == '4' ? $result[$key]['status_designation'] = "Duty Cover" : "";
            $result[$key]['status_designation'] == '5' ? $result[$key]['status_designation'] = "Contracts" : "";
            $result[$key]['monthly_fuel_allowance'] == '0' ? $result[$key]['monthly_fuel_allowance'] = "" : "";
            $result[$key]['monthly_fuel_allowance'] == '1' ? $result[$key]['monthly_fuel_allowance'] = "Yes" : "";
            $result[$key]['monthly_fuel_allowance'] == '2' ? $result[$key]['monthly_fuel_allowance'] = "No" : "";
            $result[$key]['monthly_fuel_intake'] == '0' ? $result[$key]['monthly_fuel_intake'] = "" : "";
        }
